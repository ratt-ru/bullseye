...
def save_to_fits_image(name,size_l,size_m,
  ...
  fortran_ordered_data = data.astype(data.dtype,order="F",copy=False).reshape(cube_channel_dim_size,1,size_l,size_m)
  pri_hdr = pyfits.PrimaryHDU(fortran_ordered_data,do_not_scale_image_data=True)
  pri_hdr.header.append(("CRPIX1",centre_px_m,"Pixel coordinate of reference point"))
  ...
  pri_hdr.header.append(("CRPIX2",centre_px_l,"Pixel coordinate of reference point"))
