...
public:
    ...
    inline static void convolve(gridding_parameters & params, uvw_base_type grid_centre_offset_x,
        ...
        uvw_base_type frac_u_offset = std::rint((-uvw._u + std::lrint(uvw._u))*params.conv_oversample);
        uvw_base_type frac_v_offset = std::rint((-uvw._v + std::lrint(uvw._v))*params.conv_oversample);
        //Don't you dare go over the boundary
